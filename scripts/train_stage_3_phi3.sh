...
stage2_path=${1:-"checkpoints/ETChat-Phi3-Mini-Stage-2"}
stage3_path="work_dirs/meco-stage-3-phi3"
...
python -m torch.distributed.run --nproc_per_node 4 meco/train/train.py \
    ...
    --fp16 True \
    --anno_path data/et_instruct_164k_meco.json \
    --video_path data/ET-Instruct-164K/videos \
